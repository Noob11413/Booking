...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 01, 2021 at 05:38 AM
...
INSERT INTO `admin` (`adminID`, `Fname`, `Mname`, `Lname`, `ContactNum`, `Email`, `Username`, `Passwords`, `DateofBirth`) VALUES
(1, 'Admin', 'Terminal', 'Admin', 1234567890, 'sample.admin01@example.com', 'SampleAdmin01', '$2y$10$UrCkRbIRzjYeVN1fr8ts0.XYyhIu4d62QbgXhaZ8uVH2rYxBbHkn6', '0000-00-00');
...
INSERT INTO `customer` (`customerID`, `Fname`, `Mname`, `Lname`, `ContactNum`, `Email`, `Username`, `Passwords`, `DateofBirth`) VALUES
(1, 'Sample', 'User', 'Thingey', 1234567890, 'sample.tester01@example.com', 'SampleTester01', '$2y$10$UrCkRbIRzjYeVN1fr8ts0.XYyhIu4d62QbgXhaZ8uVH2rYxBbHkn6', '2021-05-31'),
(2, 'John', 'M', 'Doe', 912345678, 'johndoe@email.com', 'JohnDoe123', '$2y$10$oyDUHfIIXwHHpTB97p8zi.lwSgG8vyUzcd2rXTjTRKnUlSkx0mVze', '2021-05-01');
...
INSERT INTO `driver` (`driverID`, `LicenseNum`, `Fname`, `Mname`, `Lname`, `ContactNum`, `Email`, `Username`, `Passwords`, `DateofBirth`) VALUES
(1, 'N03-12-123456', 'Sample', 'Vhire', 'Driver', 1234567890, 'sample.driver01@example.com', 'SampleDriver01', '$2y$10$UrCkRbIRzjYeVN1fr8ts0.XYyhIu4d62QbgXhaZ8uVH2rYxBbHkn6', '0000-00-00'),
(2, 'ABC1234', 'Kathleen Iza', 'M', 'Monzales', 912345678, 'monzalesiza@gmail.com', 'KathleenIza123', '$2y$10$kCT8p07JwWEXT2dFs.aHKOMxsFjIcpSe2yLmPx1Eww3EbSVjVXY46', '2021-05-14');
...
(11, 1, 'CLNK-AYLA', 14, '08:45:00', '09:30:00', 'OPEN'),
(20, 2, 'CLNK-SMCC', 16, '08:00:00', '08:45:00', 'OPEN'),
(21, 2, 'SMCC-CLNK', 16, '08:45:00', '09:30:00', 'OPEN'),
(30, 3, 'SMCC-SMSC', 13, '08:00:00', '08:45:00', 'OPEN'),
...
INSERT INTO `vhire` (`vehicleID`, `driverID`, `PlateNum`, `Brand`, `Model`, `Color`, `Capacity`, `Weight`) VALUES
(1, 2, 'ABC1234', 'Toyota', 'Avanza', '#ff0000', 1, 1),
(2, 2, 'ABC1234', 'Toyota', 'Innova', '#FFFFFF', 16, 24.5),
(3, 1, 'ANZ9874', 'Izuzu', 'Ambot', '#000000', 14, 25.3);
